...
def SNES(f, x0, maxEvals=2e6, verbose=False, targetFitness=-1e-10):  #***
    ...
    return bestFound, bestFitness, numEvals  #***
...
if __name__ == "__main__":
    ...
    # 1000-dimensional ellipsoid function
    dim = 1000  #***
    ...
    # example run
    print(SNES(elli, 4 * ones(dim), verbose=True))  #***
